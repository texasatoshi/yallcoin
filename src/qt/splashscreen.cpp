    ...
    QSplashScreen(pixmap, f)
{
	...
	QString copyrightText3   = QChar(0xA9)+QString(" %1 ").arg(2021) + QString(tr("The YALLcoin Developers")); // cc
    ...
    pixPaint.setPen(QColor(76,76,76)); // cc
    ...
    pixPaint.drawText(paddingLeftCol2,paddingTopCol2+line3,copyrightText3);  // cc
